    ...
    describe('A LivefyreBootstrapClient', function () {
        ...
        describe("when constructed with normal opts", function () {
            ...
            it("requests correct URL when opts.environment is undefined", function () {
                ...
                runs(function () {
                    var mostRecentRequest = bootstrapClient._request.mostRecentCall.args[0];
                    expect(mostRecentRequest.url).toBe('http://bootstrap-cdn.livefyre.com/bs3/v3.1/playstation.fyre.co/342776/Y3VzdG9tLTEzNzg5NTE0MTE4NDA=/init');
                });
            });
        });
        ...
        describe("when configured with opts.version", function () {
            ...
            it("requests the bootstrap service with that version in the path", function () {
                ...
                expect(requestedUrl).toBe('http://bootstrap-cdn.fyre/bs3/v3.1/livefyre.com/286472/NTA5Mzg4YzAtYTI3Mi00MTcwLTk4YjktNzE0OTczYjM3NTM4/init');
            });
        });
        ...
        describe("when configured with environment='fy.re'", function () {
            var opts,
                callback;
            beforeEach(function () {
                opts = {
            ...
            it("requests the correct bootstrap URL for localdev", function () {
                bootstrapClient.getContent(opts, callback);
                var requestedUrl = bootstrapClient._request.mostRecentCall.args[0].url;
                expect(requestedUrl).toBe('http://bootstrap-cdn.fy.re/bs3/v3.1/livefyre.com/286472/NTA5Mzg4YzAtYTI3Mi00MTcwLTk4YjktNzE0OTczYjM3NTM4/init');
            });
        });
        ...
        describe("when configured without opts.environment (prod)", function () {
            ...
            it("requests the correct bootstrap URL for prod", function () {
                bootstrapClient.getContent(opts, callback);
                var requestedUrl = bootstrapClient._request.mostRecentCall.args[0].url;
                expect(requestedUrl).toBe('http://bootstrap-cdn.livefyre.com/bs3/v3.1/livefyre.com/313878/MQ==/init');
            });
        });
        ...
        describe('when configured with opts.protocol=https', function () {
            ...
            it('makes request to different URL using https and jsonp', function () {
                ...
                expect(ajaxArgs.url).toBe('https://bootstrap-cdn.qa-ext.livefyre.com/bs3/v3.1/qa-ext.livefyre.com/backplane-qa.fyre.co/290598/MQ==/init');
            });

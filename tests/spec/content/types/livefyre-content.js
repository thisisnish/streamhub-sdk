...
function ($, LivefyreContent) {
    ...
    describe('A LivefyreContent object', function () {
        var mockData = {};
        mockData.livefyreBootstrapContent = {"source": 1, "content": {"replaces": "", "parentId": "", "bodyHtml": "oh hi there", "title": "a title", "id": "tweet-308584114829795328@twitter.com", "authorId": "890999516@twitter.com", "updatedAt": 1362407161, "annotations": {}, "createdAt": 1362407161}, "vis": 1, "type": 0, "event": 1362407161286515, "childContent": [], author: {displayName: "sara",tags: [ ],profileUrl: "https://twitter.com/#!/135sara",avatar: "http://a0.twimg.com/profile_images/1349672055/Baqueira_29-01-2010_13-54-52_normal.jpg",type: 3,id: "123568642@twitter.com"}};
        mockData.livefyreBootstrapContentWithUrl = {"source": 1, "content": {"replaces": "", "parentId": "", "bodyHtml": "oh hi there http://google.com", "title": "a title", "id": "tweet-308584114829795328@twitter.com", "authorId": "890999516@twitter.com", "updatedAt": 1362407161, "annotations": {}, "createdAt": 1362407161}, "vis": 1, "type": 0, "event": 1362407161286515, "childContent": [], author: {displayName: "sara",tags: [ ],profileUrl: "https://twitter.com/#!/135sara",avatar: "http://a0.twimg.com/profile_images/1349672055/Baqueira_29-01-2010_13-54-52_normal.jpg",type: 3,id: "123568642@twitter.com"}};
        ...
        it('should linkify the body', function () {
            mock = mockData.livefyreBootstrapContentWithUrl;
            content = new LivefyreContent(mock);
            expect(content.body).toBe('oh hi there <a href="http://google.com" target="_blank" rel="nofollow">http://google.com</a>');
        });
        ...
        it('should allow title to be set on instance', function () {
